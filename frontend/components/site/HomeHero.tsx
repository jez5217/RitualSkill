...
export function HomeHero({ skillsUrl }: { skillsUrl: string }) {
  ...
  return (
    <div
      ref={ref}
      className="relative left-1/2 -translate-x-1/2 w-screen h-[76vh] min-h-[520px] max-h-[820px]
    ...
    >
      ...
      >
        ...
        <h1 className="font-display text-5xl sm:text-7xl text-gray-100 tracking-tight leading-[0.98] mb-5 max-w-3xl">
