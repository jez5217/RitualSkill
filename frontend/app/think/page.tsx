  ...
  return (
    <main className="max-w-6xl mx-auto px-4 sm:px-6 py-10 sm:py-16">
      <section className="think-hero">
        ...
        <div className="think-visual" aria-hidden="true">
          <div className="think-visual-entry">
            <img src="/images/think-ai-core.png" alt="" className="think-core" />
          </div>
        </div>
      </section>
