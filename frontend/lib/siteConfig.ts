...
// this ever moves off ritualagentlab.vercel.app (e.g. a custom domain) —
...
export const SITE_URL = process.env.NEXT_PUBLIC_SITE_URL || "https://ritualagentlab.vercel.app";
